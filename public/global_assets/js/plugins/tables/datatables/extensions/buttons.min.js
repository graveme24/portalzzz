    ...
    o.ext.buttons.pdfHtml5 = {
        ...
        action: function(a, b, d, c) {
            ...
            d = {
                ...
                content: [{
                    table: { headerRows: 1, body: f }

                }],
                styles: {
                    tableHeader: { bold: !0, fontSize: 10, color: "white", fillColor: "#2d4154", alignment: "center", margin: 4 },
                    tableBodyEven: { margin: 5, alignment: "center" },
                    tableBodyOdd: { fillColor: "#f3f3f3", margin: 5, alignment: "center" },
                    tableFooter: { bold: !0, fontSize: 11, color: "white", fillColor: "#2d4154" },
                    title: { alignment: "center", fontSize: 16, bold: true },
                    message: {},
                    content: [{

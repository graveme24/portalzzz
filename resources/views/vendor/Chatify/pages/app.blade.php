        ...
        <div class="m-header">
            <nav>
                ...
                <nav class="m-header-right">
                    <a href="/" class="listView-h"><i class="fas fa-home"></i></a>
        ...
        <div class="m-header m-header-messaging">
            <nav>
                ...
                <div style="display: inline-flex;">
                    ...
                    <div class="avatar av-s header-avatar" style="margin: 0px 10px; margin-top: -5px; margin-bottom: -5px; background-image: url('{{ asset('/storage/uploads/logo.jpg')}}');">
                    </div>

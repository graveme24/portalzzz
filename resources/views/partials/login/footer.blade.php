<div class="navbar navbar-expand-lg navbar-light">
    ...
    <div class="navbar-collapse collapse" id="navbar-footer">
        ...
        <ul class="navbar-nav ml-lg-auto">
            ...
            <li class="nav-item"><a href="#" class="navbar-nav-link" ><i class="icon-lifebuoy mr-2"></i> Privacy Policy</a></li>
            <li class="nav-item"><a href="#" class="navbar-nav-link" ><i class="icon-file-text2 mr-2"></i> Terms of Use </a></li>

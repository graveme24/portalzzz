        ...
        @if(!Qs::userIsTeacher())
            ...
            <div class="card-body collapse">
                <table class="table table-bordered table-responsive text-center">
                    ...
                    @if($ex->term < 4) {{-- 1st,2nd and 3rd Term--}}
                    ...
                    @endforeach
                    <tr>
                        <td colspan="3"><strong>TOTAL SCORES OBTAINED: </strong> {{ $exr->total ?: 'N/A' }}</td>
                        <td colspan="{{ $ex->term < 4 ? 3 : 7 }}"><strong>FINAL AVERAGE: </strong> {{ $exr->ave ?: 'N/A'}}</td>
                        {{-- <td colspan="{{ $ex->term < 4 ? 5 : 5 }}"><strong>CLASS AVERAGE: </strong> {{ $exr->class_ave ?: 'N/A' }}</td> --}}
